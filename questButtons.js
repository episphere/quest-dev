...
export const getButtonDiv = (button_text_obj, hasInputField, questID, endMatch, target) => {
    ...
    */
    ...
    let nextButton = `<button type='submit' class='next w-100' ${target} aria-label='Next question' data-click-type='next'>${button_text_obj.next}</button>`;
    ...
    */
    ...
    let resetButton = `<button type='submit' class='reset w-100' aria-label='Reset this answer' data-click-type='reset'>${button_text_obj.reset}</button>`;       
    ...
    */
    ...
    let prevButton = `<button type='submit' class='previous w-100' aria-label='Back to the previous question' data-click-type='previous'>${button_text_obj.back}</button>`;
