...
export const runtimeDefects = Object.freeze({
  ...
  corpusMalformedCondition: defect('QD-CORPUS-001', 'Malformed production grid condition', 'The COVID-19 grid condition is missing its closing parenthesis and contains an incomplete/invalid response-ID complement, so its intended display logic cannot be evaluated as authored.', {
  ...
  corpusDuplicateScalarId: defect('QD-CORPUS-002', 'Duplicate production scalar response ID', 'The Module 1 esophageal-cancer question gives its age and year inputs the same response/DOM ID, so the values cannot be independently stored or restored.', {
    owner: 'Questionnaire maintainers',
    corpusCommit: '7ae99a22af325cf0e14be047a7636462db9bfd50',
